...
mod tests {
    ...
    use crate::{EventStore, ledger_query_service_impl::LedgerQueryServiceImpl};
        ...
        fn prop_ledger_query_accuracy(
            ...
            tokio::runtime::Runtime::new().unwrap().block_on(async {
                ...
                for i in 0..num_entries {
                    ...
                    // イベントを保存
                    EventRepository::append_events(&*event_store, &entry_id, vec![draft_event, posted_event]).await.unwrap();
                }
    ...
    async fn test_ledger_query_simple() {
        ...
        // イベントを保存
        EventRepository::append_events(&*event_store, &entry_id, vec![draft_event, posted_event])
            .await
            .unwrap();
